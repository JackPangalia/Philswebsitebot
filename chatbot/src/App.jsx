...
function App() {
  ...
  return (
    <div className="bg-gray-50 w-full h-screen">
      <div className="absolute bottom-16 right-4 bg-red-400 h-[675px] w-[400px] ">
        <div className="rounded-2xl  h-[96%] shadow-sm bg-white ">
          {/* Chat area */}
          <div className="h-[92%] flex flex-col gap-4 overflow-y-auto px-5 py-5">
          ...
          <form 
            ...
            className="shadow-sm border-2 border-zinc-100 p-1 rounded-4xl flex justify-between focus-within:border-black absolute w-[90%] bottom-2  bg-white "
          >
            <input
